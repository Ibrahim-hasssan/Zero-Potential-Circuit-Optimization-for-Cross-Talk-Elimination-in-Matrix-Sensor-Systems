...
#linear_values = [40000, 50000, 90000, 100000]
...
origTxt = "C:\\Users\\aboal\\Desktop\\zpc_project\\final tasks\\05-zpc_R11with DIBS-Delay and Doppler Invariant Binary Sequence\\sq with res.txt"
...
for indx, eachFile in enumerate(listALL):
 ...
 # print(f"figures #: {indx} - file name: {eachFile} - f = 200 Hz | measured resistance: Rmn = {Rmn:.4f} Ohms | capacitor: Cmn = {Cmn*1e12:.6e} pF")
    ...
    # Plot the frequency componentsfft as bar chart
